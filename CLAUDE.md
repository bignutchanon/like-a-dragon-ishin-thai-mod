...
10. **เลขบิลด์ทดสอบ ≠ เลขเวอร์ชันที่ปล่อย** — ทดสอบใช้ `pack_release.py --test` (ได้ `build/IshinThai_test_NN_P.pak`
    · จดลง `work/testbuilds.md` · ไม่มี zip ไม่แตะ `patch.md`) · เลขเวอร์ชันนับต่อจากที่ปล่อยบน GitHub เท่านั้น
    ปล่อยจริงค่อยใช้ `--version vX.Y` และต้องมีหัวข้อของเวอร์ชันนั้นใน `patch.md` ก่อน
11. ข้อเท็จจริงเรื่องไฟล์เกม **ต้องมาจากการเปิดไฟล์จริง** — ห้ามสรุปจากชื่อไฟล์
